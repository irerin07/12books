...
/**
 * 한 사람이 한 책을 읽은 <b>한 회차</b>의 기록. 같은 책에 여러 행이 쌓일 수 있고, 유일한 것은
 * <b>서재에 꽂혀 있는 행</b>뿐이다({@code uk(user_id, shelved_book_id)}, V8). 뺐던 책을 다시
 * 담을 때 이어서 읽을지 새로 시작할지는 사용자가 고른다 — 새로 시작이 새 행이다.
 *
